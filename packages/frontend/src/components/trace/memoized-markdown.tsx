  ...
  ({ text, className }: { text: string; className?: string }) => (
    <div
      className={cn(
        ...
        "prose-th:border-b prose-th:border-r prose-th:border-border prose-th:px-3 prose-th:py-2 prose-th:text-left prose-th:text-xs prose-th:font-semibold last:prose-th:border-r-0",
        ...
        "prose-blockquote:border-l-2 prose-blockquote:border-foreground/20 prose-blockquote:bg-muted/30 prose-blockquote:rounded-r-md prose-blockquote:py-1 prose-blockquote:px-4 prose-blockquote:not-italic prose-blockquote:text-muted-foreground",
